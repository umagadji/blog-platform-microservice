package ru.umagadzhi.like_service.handler;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ExecutionException.class) // Этот метод обрабатывает исключение ExecutionException.
    ...
    @ExceptionHandler(TimeoutException.class) // Этот метод обрабатывает исключение TimeoutException.
