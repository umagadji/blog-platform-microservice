package ru.umagadzhi.comment_service.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/comments/**").permitAll()  // Разрешаем неавторизованный доступ к /api/comments/**
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:8083"));  // Разрешённые источники (фронтенд)
